...
@section('header_title', 'Retur Pembelian')
@section('content')
<div class="space-y-4">
            ...
            <table class="w-full text-sm">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-slate-50 dark:border-white/5 hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">
                        <td class="p-4 font-mono font-bold text-blue-500">{{ $r->pembelian->no_faktur ?? '-' }}</td>
                    ...
                    @empty
                    <tr><td colspan="4" class="p-8 text-center text-slate-400">Tidak ada retur pembelian</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
